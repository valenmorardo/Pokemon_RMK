  ...
  return (
    <div className={s.card}>
      <Link to={`/home/pokemon/${_id}`}>
        ...
        <h4 className={s.statTitle}>DEFENSE: <span>{Defense}</span></h4>
        <h4 className={s.statTitle}>ATTACK: <span>{Attack}</span></h4>
        <h4 className={s.statTitle}>SPEED: <span>{Speed}</span></h4>
        <h4 className={s.statTitle}>LIFE: <span>{Life}</span></h4>
